function data = dicm2nii_multicoil(strpattern)
...
nbcoils = i-1;
%save_nii(data,[outputfolder filesep sct_tool_remove_extension(file{1},0) '.nii.gz'],[outputfolder filesep  sct_tool_remove_extension(file{1},0) '_coil' num2str(nbcoils) '.nii']);
