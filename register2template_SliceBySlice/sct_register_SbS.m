...
sct_unix('sct_register_multimodal -i src_reslice.nii -d dest.nii -param step=1,algo=translation,metric=MeanSquares,slicewise=1,smooth=4:step=2,slicewise=1,algo=affine:step=3,algo=bsplinesyn,slicewise=1:step=4,algo=syn,gradStep=0.2,smooth=0.1,metric=CC')
